package edu.wit.yeatesg.multiplayersnakegame.datatypes.buffs;
...
public abstract class BuffAnimationScript
{
	...
	public BuffAnimationScript(Client container, SnakeData whoGotTheBuff, int tickRate, int animationRate, long duration)
	{
	...
	public BuffAnimationScript(Client container, SnakeData whoGotTheBuff, int tickRate, int animationRate, int numTicks)
	{
